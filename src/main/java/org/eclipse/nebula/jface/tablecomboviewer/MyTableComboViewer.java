...
public class MyTableComboViewer extends AbstractTableViewer {
	...
	private MyTableCombo tableCombo;
	...
	public MyTableComboViewer(Composite parent) {
	 ...
	 * 		SWT style bits
	 */
	public MyTableComboViewer(Composite parent, int style) {
		this(new MyTableCombo(parent, style));
	}
	 ...
	 * 		the table control
	 */
	public MyTableComboViewer(MyTableCombo tableCombo) {
	 ...
	 * @return
	 */
	public MyTableCombo getTableCombo() {
		return tableCombo;
	}
