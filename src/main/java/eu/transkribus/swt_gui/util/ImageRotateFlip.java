...
public class ImageRotateFlip {
	...
	/**
	 * Rotates SWT ImageData
	 * @param srcData ImageData to rotate
	 * @param direction SWT.LEFT (rotate left by 90°), SWT.RIGHT (rotate right by 90°) or SWT.DOWN (rotate by 180°)
	 * @return New rotated ImageData
	 */
