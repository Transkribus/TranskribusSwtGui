 ...
 *
 */
public class TaggingWidgetOld extends Composite implements Observer {
	private final static Logger logger = LoggerFactory.getLogger(TaggingWidgetOld.class);
...
//	}
	 ...
	 */
	public TaggingWidgetOld(Composite parent, int style, int type, boolean withProperties) {
		super(parent, style);
			...
			@Override public void update(ViewerCell cell) {				
                ...
                colorCtrl.addPaintListener(new PaintListener() {
        			...
        			public void paintControl(PaintEvent e) {
        				e.gc.setForeground(TaggingWidgetOld.getTagColor(tagName));
        				e.gc.setBackground(TaggingWidgetOld.getTagColor(tagName));
        				int o = 0;
		...
		CellLabelProvider addButtonColLabelProvider = new CellLabelProvider() {
			@Override public void update(final ViewerCell cell) {
				...
				if (c.getAddButton() != null)
					c.getAddButton().addSelectionListener(new AddTagSelectionListener(listener, TaggingWidgetOld.this, tagName));
