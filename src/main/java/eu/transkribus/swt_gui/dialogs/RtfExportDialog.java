...
//	Label pathLabel;
	...
	public RtfExportDialog(Shell parent, int style, String lastExportFolder, int nrOfPages, String adjustedDocName) {
...
//		shell.setSize(673, 420);
		...
		shell.setText("Export RTF");
		shell.setLayout(new GridLayout(3, false));
		
		exportPathComp = new ExportPathComposite(shell, lastExportFolder, "File name: ", RTF_EXT, adjustedDocName);
