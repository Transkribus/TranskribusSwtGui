...
public class OldKeywordSpottingComposite extends Composite {
	private final static Logger logger = LoggerFactory.getLogger(OldKeywordSpottingComposite.class);
...
//	LabeledCombo kwsCollection;
	...
	public OldKeywordSpottingComposite(Composite parent, int style) {
		super(parent, style);
