...
public class CollectionManagerListener2 extends AStorageObserver implements SelectionListener, DragSourceListener  {
	private final static Logger logger = LoggerFactory.getLogger(CollectionManagerListener2.class);
	
	CollectionManagerDialog2 cmw;
	TrpMainWidget mw;
	Storage store = Storage.getInstance();
	Shell shell;
	
	public CollectionManagerListener2(CollectionManagerDialog2 cmw) {
		this.cmw = cmw;
		shell = cmw.getShell();
