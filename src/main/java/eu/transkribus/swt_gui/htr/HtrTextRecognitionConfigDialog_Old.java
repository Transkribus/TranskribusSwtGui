...
/**
 * @deprecated old and not used anymore
 */
public class HtrTextRecognitionConfigDialog_Old extends Dialog {
...
//	private Combo ocrLangCombo, typeFaceCombo;

	private TrpHtr htr;
	private TextRecognitionConfig config;

	public HtrTextRecognitionConfigDialog_Old(Shell parent, TextRecognitionConfig config) {
		super(parent);
		this.config = config;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		htrDictComp = new HtrDictionaryComposite(uroSash, 0);
