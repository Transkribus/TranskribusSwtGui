...
//		Fonts.setBoldFont(labelBaseModel);
		
		baseModelBtn = new HtrModelChooserButton(this, 0);
...
//		Fonts.setBoldFont(epochsTxt.getLabel());
		
//		epochsTxt.getTextField().addVerifyListener( new VerifyListener() {
//			@Override
//			public void verifyText(VerifyEvent e) {
//				final String oldS = epochsTxt.getText();
//			    final String newS = oldS.substring(0, e.start) + e.text + oldS.substring(e.end);
//				System.out.println("isvalid: "+CitLabSemiSupervisedHtrTrainConfig.isValidTrainingEpochsString(newS));
//				
//				e.doit = CitLabSemiSupervisedHtrTrainConfig.isValidTrainingEpochsString(newS);
//			}
//		});
...
//		subsamplingTxt.setValidateToInt(true);
		subsamplingTxt.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
//		Fonts.setBoldFont(subsamplingTxt.getLabel());
...
//		Fonts.setBoldFont(removeLineBreaksCheck);
		
		Label noiseLbl = new Label(this, SWT.NONE);
		noiseLbl.setText("Noise:");
//		Fonts.setBoldFont(noiseLbl);
...
//		numberOfThreadsTxt.setValidateToInt(true);
		numberOfThreadsTxt.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
//		Fonts.setBoldFont(numberOfThreadsTxt.getLabel());
