...
//    private String titleString;
    ...
    public AddOptionDialog(int featId, EditDeclManagerDialog efd) {
        super(efd.getShell());
        this.opt = new EdOption();
        this.opt.setFeatureId(featId);
        this.efd = efd;
    }
    ...
    protected void configureShell(Shell newShell)
    {
        ...
        newShell.setText("Create Option");
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        textField.setSize(30, textField.getSize().y);
