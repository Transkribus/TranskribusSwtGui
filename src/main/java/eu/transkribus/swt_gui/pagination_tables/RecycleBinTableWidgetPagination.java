...
public class RecycleBinTableWidgetPagination extends ATableWidgetPagination<TrpTranscriptMetadata> {
	...
	public RecycleBinTableWidgetPagination(Composite parent, int style, int initialPageSize) {
