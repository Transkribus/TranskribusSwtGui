...
public class TrpCanvasAddMode extends CanvasMode {
	...
	public final static CanvasMode ADD_TEXTREGION = new TrpCanvasAddMode(true, false, false, true, "TextRegion");
	...
	public final static CanvasMode ADD_TABLEREGION = new TrpCanvasAddMode(true, false, false, true, "TableRegion");
